    ...
    return (
        <div className="content">
            <div className="buttons-container">
                ...
                <TextField type="number" value={years} label="Amortization (years)" InputProps={{ endAdornment: <InputAdornment position="end">years</InputAdornment>}} onChange={(event => setYears(parseInt(event.target.value)))} />
